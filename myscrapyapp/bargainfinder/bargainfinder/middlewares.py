...
class BargainfinderSpiderMiddleware:
...
class BargainfinderDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        print('************fake_user_agent_attached********')
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def _get_headers_list(self):
        ...
        print('*****22222222222fakeheaderlist22222222222222222222222222222')
        print(self.headers_list)


    def _get_random_browser_header(self):
        random_index = randint(0, len(self.headers_list) - 1)
        print('*****111111111111fake random header selected11111111111111111111111111111111111111111')
    ...
    def process_request(self, request, spider):        
        ...
        print('xxxxxxxxxxxxxrequest.headersxxxxxxxxxxxx')
